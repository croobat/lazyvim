...
map("n", "<leader>aF", "<cmd>set foldmethod=marker<cr>", { desc = "Fold mark" })
map("n", "<leader>ah", "<cmd>lua vim.opt.hlsearch = true<cr>", { desc = "Highlight on" })
map("n", "<leader>aH", "<cmd>nohlsearch<cr>", { desc = "Highlight off" })
map("n", "<leader>ai", "<cmd>setlocal autoindent<cr>", { desc = "Auto-indent on" })
map("n", "<leader>aI", "<cmd>setlocal noautoindent<cr>", { desc = "Auto-indent off" })
map("n", "<leader>al", "<cmd>set colorcolumn=79<cr>", { desc = "Color column on" })
map("n", "<leader>aL", "<cmd>set colorcolumn=0<cr>", { desc = "Color column off" })
map("n", "<leader>at", "<cmd>set shiftwidth=2 tabstop=2<cr>", { desc = "Indent 2 spaces" })
map("n", "<leader>aT", "<cmd>set shiftwidth=4 tabstop=4<cr>", { desc = "Indent 4 spaces" })
map("n", "<leader>ac", "<cmd>setlocal formatoptions+=cro<cr>", { desc = "Auto-comment on" })
map("n", "<leader>aC", "<cmd>setlocal formatoptions-=cro<cr>", { desc = "Auto-comment off" })
map("n", "<leader>as", "<cmd>%s/\\s\\+$//e<cr>", { desc = "Remove traling spaces" })
